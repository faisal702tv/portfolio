...
export const AI_PROVIDERS: AIProvider[] = [
  {
    ...
    models: [
      ...
      { id: 'glm-5-turbo', name: 'GLM-5 Turbo', nameAr: 'GLM-5 Turbo', capabilities: ['سريع', 'متوازن'] },
      ...
      { id: 'glm-4.6', name: 'GLM-4.6', nameAr: 'GLM-4.6', capabilities: ['مستقر', 'رخيص'] },
  ...
  },
  {
    ...
    name: 'OpenAI',
    nameAr: 'OpenAI',
    description: 'GPT-5.4, GPT-4.1, o3-pro, o4-mini',
    icon: '🤖',
    color: 'bg-teal-500',
    ...
    models: [
      { id: 'gpt-5.4', name: 'GPT-5.4', nameAr: 'GPT-5.4', capabilities: ['أحدث', 'أقوى أداء'], recommended: true },
  ...
  },
  {
    ...
    description: 'Claude 4.6 Opus/Sonnet, Haiku 4.5',
    icon: '🧠',
    color: 'bg-amber-600',
    ...
    models: [
      { id: 'claude-opus-4-6-20260205', name: 'Claude Opus 4.6', nameAr: 'Claude Opus 4.6', capabilities: ['أقوى أداء', 'سياق 1M', 'كود'], recommended: true },
  ...
  },
  {
    ...
    description: 'Gemini 3.1 Pro, 2.5 Pro/Flash',
    icon: '🔮',
    color: 'bg-red-500',
  ...
  },
  {
    ...
    models: [
      { id: 'openrouter/free', name: 'Free Auto Router', nameAr: 'راوتر مجاني تلقائي', capabilities: ['مجاني', 'تلقائي'], recommended: true, free: true },
      { id: 'qwen/qwen3.6-plus:free', name: 'Qwen 3.6 Plus', nameAr: 'Qwen 3.6 Plus', capabilities: ['مجاني', 'أقوى', 'كود'], free: true },
      ...
      { id: 'google/gemma-4-31b-it:free', name: 'Gemma 4 31B', nameAr: 'Gemma 4 31B', capabilities: ['مجاني', 'Google', 'أحدث'], free: true },
      ...
      { id: 'openai/gpt-5.4', name: 'GPT-5.4', nameAr: 'GPT-5.4', capabilities: ['أحدث OpenAI'] },
      ...
      { id: 'anthropic/claude-opus-4.6', name: 'Claude Opus 4.6', nameAr: 'Claude Opus 4.6', capabilities: ['أقوى Claude'] },
